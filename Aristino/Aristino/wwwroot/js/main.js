...
------------------------------ */  
	$('.product-slider').slick({
		...
		slidesToShow: 4,
		slidesToScroll: 1,
		prevArrow: '<button type="button" class="slick-prev"><br/><i class="zmdi zmdi-chevron-left" style="font-weight:bold;font-size:20px"></i><br/><br/></button>',
		nextArrow: '<button type="button" class="slick-next"><br/><i class="zmdi zmdi-chevron-right" style="font-weight:bold;font-size:20px"></i><br/><br/></button>',
		responsive: [
